  ...
  json_schema <- '{
    ...
    "models": {
      "model1": {
        ...
        "paths": [
          {"fromLabel": "F1", "toLabel": "x1", "numberOfArrows": 1, "free": "free"}
        ]
      }
    }
  }'
    ...
    models = list(
      model1 = list(
        ...
        paths = list(
          ...
          list(fromLabel = "x2", toLabel = "x2", numberOfArrows = 2, free = "fixed", value = 1.0),
          list(fromLabel = "1", toLabel = "x1", numberOfArrows = 1, free = "free"),
          list(fromLabel = "1", toLabel = "x2", numberOfArrows = 1, free = "free")
        ),
