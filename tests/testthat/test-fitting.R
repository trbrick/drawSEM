  ...
  schema <- list(
    ...
    models = list(
      model1 = list(
        ...
        paths = list(
          list(fromLabel = "Factor", toLabel = "x1", numberOfArrows = 1, free = "free", parameterType = "loadings"),
          list(fromLabel = "Factor", toLabel = "x2", numberOfArrows = 1, free = "free", parameterType = "loadings")
        ),
        optimization = list(
          fitFunction = "ML",
          missingness = "FIML",
